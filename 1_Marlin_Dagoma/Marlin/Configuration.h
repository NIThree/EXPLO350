...
#define STRING_CONFIG_H_AUTHOR "NI3"
...
#define CUSTOM_MACHINE_NAME "EXPLOER 350"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 31.96
  #define  DEFAULT_Ki 4.06
  #define  DEFAULT_Kd 62.84
...
#define  DEFAULT_bedKp 368.29
#define  DEFAULT_bedKi 70.69
#define  DEFAULT_bedKd 479.70
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + Y_MAX_POS) / 2)    // Y point for Z homing when homing all axis (G28).
	...
	//#define Z_SAFE_HOMING_X_POINT (175)
	//#define Z_SAFE_HOMING_Y_POINT (175)
#endif
